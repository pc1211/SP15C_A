...
public class SideDotMatrixDisplayUpdater {
    ...
    public SideDotMatrixDisplayUpdater(DotMatrixDisplayView dotMatrixDisplayView) {
        super();
    ...
    private void init() {
        ...
        //setupRunnableTime();
        dotMatrixDisplayView.setExternalMarginCoeffs(ALIGN_WIDTH_HEIGHT);
        dotMatrixDisplayView.setInternalMarginCoeffs(new RectF(0.02f, 0.02f, 0.02f, 0.02f));
        setupDefaultFont();
        setupExtraFont();
        setupColorIndexes();
        setupMargins();
    ...
    private void setupDimensions() {       //  La grille (gridRect) contient le temps et le label, et seule une partie est affichée (gridDisplayRect, glissant en cas de scroll)
        final String DIM_STRING = "123456789012345678";   //  "rad fix4 PRGM USER"
