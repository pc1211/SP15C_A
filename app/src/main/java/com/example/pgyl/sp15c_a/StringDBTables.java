...
public class StringDBTables {
    ...
    public static final int DATA_VERSION = 56;   //   A augmenter dès que les données éventuelles dans la DB existante ne seront plus comptatibles après changements
